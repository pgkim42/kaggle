...
| --- | --- | --- | ---: | ---: | --- |
| [`playground-series-s6e9`](playground-series-s6e9/) | [S6E9 — 전기차 구매 예측](https://www.kaggle.com/competitions/playground-series-s6e9) | 살지 말지 | ROC AUC | 0.94342 | 2026-09-01, 합성 데이터의 연봉/출퇴근 빈도 |
