...
This is not a winning solution. One change per run; keep only if 5-fold OOF rises. After the score is in: update this file and README.ko.md, commit, push. Do not wait.
