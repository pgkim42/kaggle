#!/usr/bin/env python3
"""S6E9 exp: LGBM ordinal + strong-column products. Same folds as exp_lgbm."""
...
def main() -> None:
    ...
    print("added subsidy_yes env_x_subsidy income_x_subsidy env_x_income")
    ...
    out = DATA / "submission_lgbm_interact.csv"
